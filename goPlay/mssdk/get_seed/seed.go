...
// GetSeed 调用 /ms/get_seed，返回 seed 及 seed_type（与 Python 的 get_get_seed 一致）
// 如果 client 不为 nil，则使用提供的客户端，否则创建新的客户端
func GetSeed(cookieData map[string]string, proxy string, client ...*http.Client) (string, int, error) {
