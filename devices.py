...
_RAM_CHOICES = ["6GB", "8GB", "12GB", "16GB"]
...
def getANewDevice(
    ...
    resolution     = f"2209x1080"  # 高x宽（符合你示例）
    resolution_v2  = f"2400x1080"  # 宽x高
    ...
    rom = str(random.randint(100000,200000))
    ...
    profile = {
        ...
        "install_id":"",
        "ua": "com.zhiliaoapp.musically/2024204030 (Linux; U; Android 15; en_US; Pixel 6; Build/BP1A.250505.005; Cronet/TTNetVersion:efce646d 2025-10-16 QuicVersion:c785494a 2025-09-30)",
        "web_ua": "Dalvik\/2.1.0 (Linux; U; Android 15; Pixel 6 Build\/BP1A.250505.005)",
        "resolution": "2209x1080",            # "高x宽"
        "dpi": 420,
        "device_type": "Pixel 6",
        "device_brand": "google",
        ...
        "os_api": 35,
        "os_version": "15",
        "resolution_v2": "2400x1080",      # "宽x高"
        "rom": "13277524",
        "rom_version": "BP1A.250505.005",          # = release_build
        "clientudid": clientudid,
        "google_aid": google_aid,
        "release_build": "4ca920e_20250626",      # = rom_version
        "display_density_v2": "xxhdpi",
        "ram_size": "8GB",
        "dark_mode_setting_value": 1,
        "is_foldable": 0,
        "screen_height_dp": 914,
        "screen_width_dp": 411,
